...
---|---|---
\*|Match zero, one or more of the previous|[Ah\*](#Bash.md) matches "Ahhhhh" or "A"
...
?=|Positive Lookahead<br/>When you look a pattern that followed by some patterns|(\w+|\d+)his\s(?=Followed) matches with `[This](#) Followed by This.`
?!|Negative Lookahead
?<=|Positive Lookbehind
?<!|Negative Lookbehind
