...
[ ]|Matches a range of char|[cbf]ar matches "car", "bar", or "far"<br/>[0-9]+ matches any positive integer<br/>[a-zA-Z] matches ascii letters a-z (UP and LO case)<br/>[^0-9] matches any character not 0-9.                                        
\||Matche previous OR next character/group|(Mon)|(Tues)day matches "Monday" or "Tuesday"                                
{ }|Matches a specified number of occurrences 	[0-9]{3} matches "315" but not "31"<br/>[0-9]{2,4} matches "12", "123", and "1234"<br/>[0-9]{2,} matches "1234567..."                          
